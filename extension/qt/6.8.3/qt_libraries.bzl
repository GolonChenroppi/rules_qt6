...
QT_LIBRARIES = [
    ...
    # --- ADDED: QtQmlIntegration ---
    ("qml_integration", "QtQmlIntegration", "Qt6QmlIntegration", [":qt_core"]),
    ...
    # --- UPDATED: QtQml depends on integration ---
    ("qml", "QtQml", "Qt6Qml", [":qt_core", ":qt_network", ":qt_qml_integration"]),
    ...
    ## qt quick
    # --- FIX 3: Add qt_qml_meta to deps ---
    ("quick", "QtQuick", "Qt6Quick", [":qt_gui", ":qt_qml", ":qt_qml_models", ":qt_qml_workerscript", ":qt_opengl", ":qt_qml_meta"]),
    ...
    ("quick_controls2_basic", "QtQuickControls2Basic", "Qt6QuickControls2Basic", [":qt_quick_templates2", ":qt_quick_controls2_impl", ":qt_quick_controls2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_basic_style_impl", "QtQuickControls2BasicStyleImpl", "Qt6QuickControls2BasicStyleImpl", [":qt_quick_controls2_basic", ":qt_quick_controls2_impl", ":qt_quick_controls2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_fusion", "QtQuickControls2Fusion", "Qt6QuickControls2Fusion", [":qt_quick_controls2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_fusion_style_impl", "QtQuickControls2FusionStyleImpl", "Qt6QuickControls2FusionStyleImpl", [":qt_quick_controls2_fusion", ":qt_quick_controls2_impl", ":qt_quick_controls2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_imagine", "QtQuickControls2Imagine", "Qt6QuickControls2Imagine", [":qt_quick_controls2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_imagine_style_impl", "QtQuickControls2ImagineStyleImpl", "Qt6QuickControls2ImagineStyleImpl", [":qt_quick_controls2_imagine", ":qt_quick_controls2_impl", ":qt_quick_controls2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_material", "QtQuickControls2Material", "Qt6QuickControls2Material", [":qt_quick_controls2", ":qt_quick_templates2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_material_style_impl", "QtQuickControls2MaterialStyleImpl", "Qt6QuickControls2MaterialStyleImpl", [":qt_quick_controls2_material", ":qt_quick_controls2_impl", ":qt_quick_controls2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_universal", "QtQuickControls2Universal", "Qt6QuickControls2Universal", [":qt_quick_controls2", ":qt_quick_templates2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_universal_style_impl", "QtQuickControls2UniversalStyleImpl", "Qt6QuickControls2UniversalStyleImpl", [":qt_quick_controls2_universal", ":qt_quick_controls2_impl", ":qt_quick_controls2", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_windows_style_impl", "QtQuickControls2WindowsStyleImpl", "Qt6QuickControls2WindowsStyleImpl", [":qt_quick_controls2", ":qt_quick_controls2_impl", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ("quick_controls2_fluent_winui3_style_impl", "QtQuickControls2FluentWinUI3StyleImpl", "Qt6QuickControls2FluentWinUI3StyleImpl", [":qt_quick_controls2", ":qt_quick_controls2_impl", ":qt_quick", ":qt_gui", ":qt_qml", ":qt_core"]),
    ...
    ("labs_platform", "QtLabsPlatform", "Qt6LabsPlatform", [":qt_quick_templates2", ":qt_widgets", ":qt_quick", ":qt_qml", ":qt_gui", ":qt_core"]),
    ...
    ("quick_dialogs2_quick_impl", "QtQuickDialogs2QuickImpl", "Qt6QuickDialogs2QuickImpl", [
        ":qt_quick_templates2",
        ":qt_quick_controls2_impl",
        ":qt_quick_dialogs2_utils",
        ":qt_quick",
        ":qt_gui",
        ":qt_qml",
        ":qt_core",
